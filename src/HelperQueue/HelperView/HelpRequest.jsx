(function() {
    ...
    module.exports = React.createClass({
        resolveRequest: function(reason) {
            this.props.api.HelpRequests.resolve(this.props.request.id, reason).then(function() {
                this.props.refresh();
        ...
        assignRequest: function(verb, helper_id) {
            ...
            this.props.api.HelpRequests[verb](this.props.request.id, helper_id).then(function() {
                this.props.refresh();
            }.bind(this), function(err) {
